        ...
        <form action="{{ route('update_user_profile') }}" method="post">
            ...
            <div class="w-full flex gap-4 py-2">
                ...
                <div class="w-[82%]">
                    ...
                    <div class="mt-3">
                        <select class="w-full border border-[#DFDFDF] !py-2 px-3 focus:outline-none"  name="official_role" id="official_roleselect">
                    ...
                    <div class="mt-3" id="official_select_html2" style="display: none;">
                        <select id="official_roleselect2" class="w-full border border-[#DFDFDF] !py-2 px-3 focus:outline-none"  name="emp_type">
                         
                        </select>
                    </div>
                    
                    <div class="mt-3" id="official_select_html3" style="display: none;">
                        <select id="official_roleselect3" class="w-full border border-[#DFDFDF] !py-2 px-3 focus:outline-none"  name="sochebaloy_dept">
                         
                        </select>
                    </div>

                    <div class="mt-3" id="official_select_html32" style="display: none;">
                        <select id="official_roleselect32" class="w-full border border-[#DFDFDF] !py-2 px-3 focus:outline-none"  name="vip_user_type">
                         
                        </select>
                    </div>
                    
                    <div class="mt-3" id="official_select_html4" style="display: none;">
                        <select id="official_roleselect4" class="w-full border border-[#DFDFDF] !py-2 px-3 focus:outline-none"  name="sochebaloy_dept_role">
