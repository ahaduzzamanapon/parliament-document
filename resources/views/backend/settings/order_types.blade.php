    ...
    <div class=" bg-white rounded-md px-4 py-6 shadow">
                ...
                <div class="w-full md:w-[35%] lg:w-[75%] relative flex items-center justify-end">
                  ...
                  <div class="w-full md:w-[35%] lg:w-[30%]">
                    <a onclick="chckprmitionh_folder3()" class="bg-[#F8B200] mt-2  md:mt-0 w-full  p-2  rounded-md font-solaimans text-white">
                        ...
                        <span>ডকুমেন্ট ধরন যোগ করুন </span>
                    </a>
                  </div>
            </div>
        </div>
            ...
            <table class="table">
              ...
              <thead class="bg-[#E9FFE4] w-full">
                <tr>
                    ...
                    <th ><h2 class="text-[#007A43] text-18 font-solaimans font-semibold ">ডকুমেন্ট ধরন নাম </h2></th>
                ...
                <td>
                    ...
                    <td>
                      <div class="flex items-center  gap-5">
                          ...
                          <a onclick="return confirm('Are you sure to delete this item?')" class="text-red-500" href="{{ route('deleteTypeOrder', $dept->id) }}"><i class="fa fa-light fa-trash-can" style="font-size: 18px;"></i></a>
                      </div>
        ...
        <dialog id="offic_dept_addId" class="modal modal-bottom sm:modal-middle">
            <div class="modal-box max-w-xs">
                ...
                <div class="my-2">
                    <form action="{{ route('storeTypeOrder') }}" method="POST">
                        @csrf
        ...
        <dialog id="ordertype_update_modal" class="modal modal-bottom sm:modal-middle">
            <div class="modal-box max-w-xs">
                ...
                <div class="my-2">
                    <form action="{{ route('updateTypeOrder') }}" method="POST">
                        @csrf
