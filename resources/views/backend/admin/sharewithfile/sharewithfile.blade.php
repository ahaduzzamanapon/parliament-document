...
<section class="px-10  py-6">
    <div class=" bg-white rounded-md px-4 py-6 shadow">
        <div class="lg:flex justify-between items-center bg-white pb-3">
            <h3 class="font-solaimans text-20 leading-5 w-full lg:w-[40%] xl:w-[25%]">Share File Manager</h3>
            <div class="w-[80%] md:flex items-center  mt-2 gap-3 lg:mt-0">
                ...
                {{-- <button onclick="creareUserModal.showModal()" class="bg-[#F8B200] mt-2  md:mt-0 w-full md:w-[25%] lg:w-[25%] p-2  rounded-md">
              ...
              <thead class="bg-[#E9FFE4] w-full">
                <tr>
                  <th><h2 class="text-[#007A43] text-18 font-solaimans font-semibold">Shared by Name</h2></th>
                    ...
                    <th class="ps-9"><h2 class="text-[#007A43] text-18 font-solaimans font-semibold ">Date & Time </h2></th>
                    <th><h2 class="text-[#007A43] text-18 font-solaimans font-semibold text-center">Folder/ File</h2></th>
                    {{-- <th><h2 class="text-[#007A43] text-18 font-solaimans font-semibold text-center">Share getting User</h2></th> --}}
                    <th><h2 class="text-[#007A43] text-18 font-solaimans font-semibold text-center">Manage</h2></th>
              ...
              <tbody>
                ...
                <tr>
                    <th class="text-[#082303] font-solaimans text-16 flex items-center gap-2">
                      <figure>
                          <img class="w-9 h-8" src="{{ asset('uploads/prp-users/3212129.png') }}" alt="">
                      </figure>
                    ...
                    <td>
                      ...
                      {{-- <td>
                        <div class="flex items-center">
                            <img  class="-me-2 w-[2.25em] h-[2.25em] rounded-full" src="{{ asset('assets/image/user1.png') }}" alt="">
                            <img class="-me-2 w-[2.25em] h-[2.25em] rounded-full" src="{{ asset('assets/image/user1.png') }}" alt="">
                            <img class="-me-2 w-[2.25em] h-[2.25em] rounded-full" src="{{ asset('assets/image/user1.png') }}" alt="">
                            <div class="-me-2 w-[2.25em] h-[2.25em] rounded-full bg-[#F6C515] flex items-center justify-center">
                    ...
                    <td>
                      <div class="flex items-center justify-center  gap-5">
                          <button class="border border-[#007A43] flex items-center gap-1 px-3 py-1 rounded">
                              ...
                              <a class="text-[#007A43] font-solaimans text-16">Manage</a>
                          </button>
