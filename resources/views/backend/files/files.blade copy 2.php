    ...
    (function(global) {
        ...
        global.onhashchange = function() {
            if (global.location.hash !== _hash) {
                const myVariable = localStorage.getItem("preavcat");
                if (myVariable == 'back') {
                    backcount++;
                    if (backcount == 5) {
                        noBackPlease();
...
<div class="w-full px-8 py-3">
    <div class="w-full px-5  py-6 lg:ps-4 bg-white rounded-md">
        <div class="lg:flex items-center gap-[0.813em]">
            <div class="form-control">
                <select id="file_type_seleted" onchange="file_type_seleted()" class="border border-[#FDD52C] rounded-md shadow-md focus:outline-none px-5 py-2">
                    ...
                    <option class="hover:bg-gray-400" value="exel">
                        Excel File
                    </option>
                    <option value="docx">
                        DOCX File
            ...
            <div class="form-control">
                <select class="border border-[#2181B8] rounded-md shadow-md focus:outline-none px-5 py-2">

                    <option value="">Sharing People</option>
                    <option class="hover:bg-gray-400" value="">
                        Documents
                    </option>
                    <option class="hover:bg-gray-400" value="">
            ...
            <div class="lg:flex justify-between items-center">
                ...
                <div class="md:flex items-center gap-1 mt-2 lg:mt-0">
                    <div class="w-full md:w-[35%] lg:w-full relative flex items-center justify-end">
                        <input onkeyup="search_Folder_file()" id="search-folder" class="w-[4.375em] ps-1 pe-8 py-1 transition-all duration-500 ease-in-out focus:translate-x-0  rounded-lg border focus:outline-none border-[#007A43]" type="text">
                    ...
                    <button class="bg-[#F8B200] mt-2 md:mt-0 w-full md:w-[75%] lg:w-full py-2  rounded-md open-file">
                        <div class="w-full h-full flex px-2  justify-center items-center gap-2">
                            ...
                            <a class="font-solaimans text-12 xl:text-14 text-white font-medium leading-normal">{{ __('messages.New') }}</a>
                        </div>
                    </button>
                </div>
            </div>
    ...
    <div id="open-file-section" class="absolute w-[12.5em] h-auto bg-white rounded-sm shadow-md hidden">
        <div class="w-full space-y-2 py-2 ">
            ...
            <div id="share" onclick="shareModal.showModal(); dropdownFileHide();set_cat_id(this);" class="flex items-center justify-start gap-1 px-2 hover:bg-gray-300 py-1">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
        ...
        <div class="flex items-center justify-start gap-1 px-2 hover:bg-gray-300 py-1">
            ...
            <a id="comment" class="text-14 font-solaimans font-semibold leading-3" onclick="openComment(event); dropdownFileHide();get_comment(this)">{{ __('messages.comments') }}</a>
        </div>
        <div class="flex items-center justify-start gap-1 px-2 hover:bg-gray-300 py-1">
            <span><i class="fa-solid fa-code-fork"></i></span>
            <a id="fileVersion" class="text-14 font-solaimans font-semibold leading-3" onclick="openFileVersion(event); dropdownFileHide();get_file_version(this)">{{ __('messages.file version') }}</a>
        </div>
        <div class="flex items-center justify-start gap-1 px-2 hover:bg-gray-300 py-1">
        ...
        <div class="flex items-center justify-start gap-1 px-2 hover:bg-gray-300 py-1">
            ...
            <a id="Delete" class="text-14 font-solaimans font-semibold leading-3" onclick='confirmDelete(event); dropdownFileHide()' data-type=1>{{ __('messages.delete') }}</a> {{--data_type 1 for folder 2 for files--}}
        </div>
    </div>
</div>
